...
def queue_hamming_distances(hex_string):
    ...
    for keysize in range(2, 40):
        ...
        hamming_distance = ChallengeUtils.hamming_distance_hex(byteset1, byteset2)
...
for i in range(2):
    ...
    for j in range(keysize):
        ...
        char = ChallengeUtils.single_character_most_english_xor(block_string)
        potential_key += chr(char)
